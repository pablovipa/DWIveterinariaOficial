 ...
 * @author Jonathan
 */
public class ModeloProducto extends ConectaBD{
    ...
    public Producto getProducto(int id){
        ...
        try {
            ...
            rs = pst.executeQuery();
            while(rs.next()){
                productos = new Producto(rs.getInt("id_producto"), rs.getString("nombre"), rs.getString("img_producto"), rs.getInt("id_categoria"), rs.getDouble("precio"), rs.getInt("stock"));
            }
        } catch (Exception e) {
